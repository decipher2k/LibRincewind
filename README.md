...
-I'm not 100% sure if the password authentication part is really safe. theoretically, it should reduce the pracitcal password length to about 1/3 compared +/- costs for trying out the first 2/3 to sqrt when cracking hashed passwords using grover.<br>
<br>
Usage:<br>
<br>
